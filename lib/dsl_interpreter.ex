defmodule PolarityReducerEx.DslInterpreter do
  ...
  # $length is a legacy alias for $original_count — both return the pre-truncation count
  ...
  # NOTE: $slice and $map_slice operate on the original list (not the truncated list),
  # allowing arbitrary range access. $truncated gives the pre-sliced truncated list.
